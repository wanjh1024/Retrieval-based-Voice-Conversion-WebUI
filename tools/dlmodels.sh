...
check_file_pretrained() {
  ...
  if [ -f "./assets/""$1""/""$2""" ]; then
      ...
      echo failed. starting download from huggingFace-mirror.
...
check_file_pretrained uvr5_weights HP2-人声vocals+非人声instrumentals.pth
check_file_pretrained uvr5_weights HP3_all_vocals.pth
check_file_pretrained uvr5_weights HP5_only_main_vocal.pth
check_file_pretrained uvr5_weights HP5-主旋律人声vocals+其他instrumentals.pth
